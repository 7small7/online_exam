...
use App\Models\Api\User\SignCollection;
...
{
    private $signCollectionModel;

    public function __construct()
    {
        $this->signCollectionModel = new SignCollection;
    }
    ...
    {
        $model = $this->signCollectionModel::query()->create($insertInfo);
    ...
    {
        $bean = $this->signCollectionModel::query()->where($closure)->first(['sign_number']);
